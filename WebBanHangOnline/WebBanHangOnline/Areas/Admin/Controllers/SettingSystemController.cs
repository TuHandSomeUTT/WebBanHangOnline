...
namespace WebBanHangOnline.Areas.Admin.Controllers
{
    public class SettingSystemController : Controller
    {
        ...
        public ActionResult AddSetting(SettingSystemViewModel req)
        {
            SaveOrUpdateSetting("SettingTitle", req.SettingTitle);
            SaveOrUpdateSetting("SettingLogo", req.SettingLogo);
            SaveOrUpdateSetting("SettingEmail", req.SettingEmail);
            SaveOrUpdateSetting("SettingHotline", req.SettingHotline);
            SaveOrUpdateSetting("SettingTitleSeo", req.SettingTitleSeo);
            SaveOrUpdateSetting("SettingDesSeo", req.SettingDesSeo);
            SaveOrUpdateSetting("SettingKeySeo", req.SettingKeySeo);

            db.SaveChanges();

            // Cách an toàn hơn: reload lại view chính để đảm bảo dữ liệu mới
            return RedirectToAction("Index");
        }

        private void SaveOrUpdateSetting(string key, string value)
        {
