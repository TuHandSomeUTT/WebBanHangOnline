    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> ForgotPassword(ForgotPasswordViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                WebBanHangOnline.Common.Common.SendMail("Gốm Sứ Bình Xuyên", "Quên Mật Khẩu", $"Quý khách vui lòng click vào <a href='{callbackUrl}'>link này</a> để reset mật khẩu", model.Email);
